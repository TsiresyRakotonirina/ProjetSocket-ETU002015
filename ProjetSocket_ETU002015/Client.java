...
public class Client extends JFrame{
    ...
    //private Scanner sc = new Scanner(System.in);//pour lire a partir du clavier
    ...
    //     try {
    //         //les informations du serveur(port et adresse IP ou nom d'hote ,127.0.0.1 est l'adresse locale de la machine)
    ...
    // public void receiveMsg(ActionEvent aevent){
    //     try {
    //         //les informations du serveur(port et adresse IP ou nom d'hote ,127.0.0.1 est l'adresse locale de la machine)
    //         clientSocket = new Socket("127.0.0.1",5000);
    //         //flux pour envoyer
